...
/**
  ...
  @class SockjsServer
  @constructor
  @param [options.sockjs_url] The url of the sockjs client, for use in an embedded iframe if necessary
**/
module.exports = function SockjsServer(options) {
...
/**
  ...
  @method
  @param socksrv the sockjs instance
**/
