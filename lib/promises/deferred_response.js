...
DeferredResponse.prototype.listenTo = function(target,eventName,options){
  ...
  this.setSubscribed()
  if (!options) { options = {}; }
  var localName = (options.as) ? options.as : "";
  var sub = function(msg){
    if (options.format) { msg = options.format.call(this, msg); }
...
DeferredResponse.prototype.setSubscribed = function() {
  this._subscribed = true;
  this._res.out({route:"/",nothing:true,req_id:this.req_id,subscribed:this._subscribed},{});
}
